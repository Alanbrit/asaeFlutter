...
import 'package:asae/src/pages/user/messages/user_messages_controller.dart';
import 'package:asae/src/models/mensaje.dart';
...
class MessagesPage extends StatelessWidget {
  ...
  Widget customAppBar(BuildContext context) {
    return SafeArea(
      child: ListTile(
        title: Text(
          '${con.userChat.nombre ?? ''} ${con.userChat.apellidos ?? ''}',
          style: TextStyle(
            fontSize: 18,
          ...
          child: AspectRatio(
            ...
            child: ClipOval(
              child: FadeInImage.assetNetwork(
                  ...
                  image: con.userChat.foto ?? 'https://bysperfeccionoral.com/wp-content/uploads/2020/01/136-1366211_group-of-10-guys-login-user-icon-png.jpg'
              ),
            ),
          ),
        ),
