...
import 'package:asae/src/providers/mensaje_provider.dart';
...
class MessagesController extends GetxController{
  ...
  void createChat() async {
    ...
    ResponseApi responsiveApi = await chatProvider.create(chat);
  ...
  void sendMensaje() async {
    ...
    ResponseApi responsiveApi = await mensajeProvider.create(mensaje);
